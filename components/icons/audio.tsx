...
const AudioIcon = ({ active = false, ...rest }: IIcon) => {
  if (active) {
    return (
      <svg {...rest} aria-label="Audio On" role="img" viewBox="0 0 24 24">
  ...
  return (
    <svg {...rest} aria-label="Audio Off" role="img" viewBox="0 0 48 48">
      <path
        clipRule="evenodd"
